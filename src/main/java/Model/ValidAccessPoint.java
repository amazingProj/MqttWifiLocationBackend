...
public class ValidAccessPoint {
    ...
    public ValidAccessPoint(){
        obj.put("b4:5d:50:bd:ac:a0", new AccessPointLocation(12, 6, 2.5, 3, 302, "floor 3 weird room", -51));
        obj.put("b4:5d:50:bd:a4:60", new AccessPointLocation(17.2, 16, 3.5, 3, 330,  "level 3 outside", -51));
