...
public class ValidAccessPoint {
    ...
    public ValidAccessPoint(){
        //obj.put("62:FB:19:26:41:57", new Coordinates(4.25, 4, 1));
        ...
        obj.put("b4:5d:50:bd:a0:80", new AccessPointLocation(7.6, 14.5, 6,4,  470));
        obj.put("b4:5d:50:bd:9e:60", new AccessPointLocation(9,5.9 , 6,4 ,460));
        obj.put("b4:5d:50:bd:93:40", new AccessPointLocation(7.9,15 , 6,4 , 450));
